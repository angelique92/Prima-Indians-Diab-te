...
def RDN(X_train,X_test,y_train,y_test,epoch):
...
if __name__ == '__main__':
    ...
    RDN(X_train, X_test, y_train, y_test,30)
    RDN(X_train, X_test, y_train, y_test,100)
    # RDN(X_train, X_test, y_train, y_test,500)
